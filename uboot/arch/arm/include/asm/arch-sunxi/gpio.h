...
#define BANK_TO_GPIO(bank) (((bank) < SUNXI_GPIO_L) ? &((struct sunxi_gpio_reg *)SUNXI_PIO_BASE)->gpio_bank[bank] : &((struct sunxi_gpio_reg *)SUNXI_R_PIO_BASE)->gpio_bank[(bank)-SUNXI_GPIO_L])
...
#else
static inline int axp_gpio_init(void)
{
    return 0;
}
#endif
